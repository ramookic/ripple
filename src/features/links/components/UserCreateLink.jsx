...
const UserCreateLinkContainer = styled.div`
...
function UserCreateLink() {
  ...
  return (
    <div>
      ...
      <UserCreateLinkContainer hidden={!showContainer}>
        <div>
          <p>Add Link</p>
      ...
      </UserCreateLinkContainer>
    </div>
  );
}

export default UserCreateLink;
